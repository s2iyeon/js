...
```ts
const todo4 = { title: '내장 객체' } as { title: string; content?: string };
todo4.content = 'Date, String, Array 등의 내장 객체 배우기';
// content가 옵셔널이므로 ! 연산자로 null/undefined가 아님을 단언
console.log(todo4.content!.toUpperCase());
```
