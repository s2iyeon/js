...
- [4. 함수에 타입 지정](#4-함수에-타입-지정)
  + [4.1 선택적 파라미터 (optional parameter)](#41-선택적-파라미터-optional-parameter)
- [5. 유니언 타입 (union type)](#5-유니언-타입-union-type)
  + [5.1 유니언 타입이란?](#51-유니언-타입이란)
- [6. 타입 별칭 (type alias)](#6-타입-별칭-type-alias)
  + [6.1 타입 별칭이란?](#61-타입-별칭이란)
  + [6.2 타입 별칭으로 객체의 타입 선언](#62-타입-별칭으로-객체의-타입-선언)
- [7. 인터섹션 타입 (intersection type)](#7-인터섹션-타입-intersection-type)
  + [7.1 인터섹션 타입이란?](#71-인터섹션-타입이란)
- [8. 인터페이스](#8-인터페이스)
  + [8.1 인터페이스란?](#81-인터페이스란)
  + [8.2 인터페이스 사용](#82-인터페이스-사용)
  + [8.3 선택적 프로퍼티 (optional property)](#83-선택적-프로퍼티-optional-property)
  + [8.4 읽기 전용 프로퍼티 (readonly)](#84-읽기-전용-프로퍼티-readonly)
  + [8.5 인터페이스 상속](#85-인터페이스-상속)
  + [8.6 계층 구조로 상속](#86-계층-구조로-상속)
  + [8.7 다중 상속](#87-다중-상속)
  + [8.8 선언 병합 (declaration merging)](#88-선언-병합-declaration-merging)
...
- [11. 리터럴 타입](#11-리터럴-타입)
  + [11.1 리터럴 타입이란?](#111-리터럴-타입이란)
- [12. 타입 단언 (type assertion)](#12-타입-단언-type-assertion)
